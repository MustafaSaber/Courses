...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var myName = x3.name$2;
      var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(myName, references);
      var this$1 = references;
      var p = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(myName$1) {
      ...
      var num1 = x4.a$2;
      var num2 = x4.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(num1, references) + this.eval__Lcalculator_Expr__sci_Map__D(num2, references))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var num1$2 = x5.a$2;
      var num2$2 = x5.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(num1$2, references) - this.eval__Lcalculator_Expr__sci_Map__D(num2$2, references))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var num1$3 = x6.a$2;
      var num2$3 = x6.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(num1$3, references) * this.eval__Lcalculator_Expr__sci_Map__D(num2$3, references))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var num1$4 = x7.a$2;
      var num2$4 = x7.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(num1$4, references) / this.eval__Lcalculator_Expr__sci_Map__D(num2$4, references))
    } else {
      return (NaN)
    }
  }
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      ...
      if ((del < 0)) {
        ...
        var bvalue = $uD(b$2.apply__O());
        var avalue = $uD(a$2.apply__O());
        var array = [(((-bvalue) + $uD($g.Math.sqrt(del))) / (2 * avalue)), (((-bvalue) - $uD($g.Math.sqrt(del))) / (2 * avalue))];
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var noOfChars = $uI(remainingCharsCount$1.apply__O());
      return ((noOfChars >= 15) ? "green" : ((noOfChars >= 0) ? "orange" : "red"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    var stringName = $as_T(x0$1.$$und1$f);
    var expretion = $as_Lcalculator_Signal(x0$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, expretion$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(expretion$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, expretion));
    var y = new $c_Lcalculator_Signal().init___F0(expr);
    return new $c_T2().init___O__O(stringName, y)
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
